...
/* VsService */
////////////////////////////////////////////////////////////////////////////////
export class VsService implements OnDestroy  {
  //////////////////////////////////////////////////////////////////////////////
  constructor(private http: HttpClient) {}
  //////////////////////////////////////////////////////////////////////////////
  private uri = `${GlobalConstants.apiURL}/api/v1/virtualserver`;
  private simpleUri = `${GlobalConstants.apiURL}/api/v1/simple/virtualserver`;
...
/* VsService */
////////////////////////////////////////////////////////////////////////////////
export class VsServiceDs implements DataSource<DbRecord>, OnDestroy {
  //////////////////////////////////////////////////////////////////////////////
  constructor(private service: VsService, private snackBar?: MatSnackBar) {}
  //////////////////////////////////////////////////////////////////////////////
  public loading$ = new BehaviorSubject<boolean>(false);
  public status$ = new BehaviorSubject<number>(0);
  ...
  delete(dbRecord: DbRecord): void {
    ...
    this.service
      ...
      .subscribe((r: HttpResponse<DbRecord>) => {
        ...
        if (r.status === 200) {
          this.snackBar.open(
            'Delete request received: ' + dbRecord.data.name,
            'Close',
            {
              duration: 10000,
            }
